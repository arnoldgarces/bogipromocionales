...
<header id="main-header"><?php include("inc/header.php"); ?></header><!-- / #main-header -->
    ...
    <form name="frmContacto" method="post" action="sendbymail.php">
	  <table align="center">
		<tr>
			<td><label for="first_name">* Digita tu nombre: </label></td>
			<td><input type="text" name="first_name" maxlength="50" size="50"></td>
		</tr>
		<tr>
			<td><label for="email">Dirección de E-mail: *</label></td>
			<td><input type="text" name="email" maxlength="80" size="50"></td>
		</tr>
        <tr>
		...
		<tr>
			<td><label for="comments">Escribenos tus inquietudes: *</label></td>
			<td><textarea name="comments" maxlength="500" cols="20" rows="20"></textarea></td>
		</tr>
		<tr>
